...
public class WekaNominalEvaluationFileCreator extends WekaEvaluationFileCreator {

	public WekaNominalEvaluationFileCreator(String fileName) throws Exception {
		super(fileName);
		addClassifier(new BayesNet());
		addClassifier(new NaiveBayes());
		addClassifier(new Logistic());
		addClassifier(new SGD());
		addClassifier(new SimpleLogistic());
		addClassifier(new SMO());
		addClassifier(new VotedPerceptron());
