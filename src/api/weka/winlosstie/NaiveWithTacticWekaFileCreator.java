...
public class NaiveWithTacticWekaFileCreator extends WekaFileCreator {

	public static void main(String[] args) {
		NaiveWithTacticWekaFileCreator creator = new NaiveWithTacticWekaFileCreator();
